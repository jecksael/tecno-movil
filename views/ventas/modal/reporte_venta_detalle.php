<form action="#" method="post" id="form-detalle-venta">
    <div class="modal fade" id="modal_detalle_venta">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4>DETALLE DE FACTURA VENTA</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="form-group col-sm-4">
                            <label for="">Responsable de la Venta:</label>
                    ...
                    <div class="col-xs-12">
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" id="ced_cli" class="form-control" readonly>
                        </div>
                        <div class="form-group col-sm-4">
                            <label for="">Nombre</label>
                            <input type="text" id="nom_cli" class="form-control" readonly>
                        </div>
                        <div class="form-group col-sm-4">
                            <label for="">Telefono:</label>
                            <input type="text" id="telf_cli" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="formm-group col-sm-12">
                            <label for="">Direccion:</label>
                            <input type="text" id="dir_cli" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <br>
